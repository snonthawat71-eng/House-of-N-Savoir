...
export const C = {
  ...
  // สีแบรนด์ใหม่ = น้ำเงิน (Royal Blue) / น้ำเงินเข้ม (Imperial) / ครีม
  brand: "#014BAA", brandSoft: "#E7EEF7",
  imperial: "#001D51", cream: "#F8F3F0",
  // สีแดง = เก็บไว้ใช้กับ error / ลบ / เตือนเท่านั้น
...
export const disp = "'Urbanist', 'Noto Sans Thai', system-ui, sans-serif";
export const sans = "'Urbanist', 'Noto Sans Thai', system-ui, sans-serif";
