...
- **วันที่อยู่บนซ้าย** ของการ์ด (ไอคอนปฏิทิน + วันแบบไทยสั้น เช่น "อา. 13 ก.ค.") · ป้าย/คนที่เกี่ยวข้องชิดขวาแถวเดียวกัน
- แถวเนื้อหา: **ปุ่ม check → เวลา → ชื่องาน** (ปุ่ม check อยู่หน้าเวลาเสมอ)
- **ปุ่ม check ทรงวงกลม 2 สถานะ**:
  - ยังไม่เสร็จ = วงกลม**โปร่ง** (`border-2` สีเทา `#C9CDD3` พื้นใส) — บนการ์ดเตือน Overview ใช้ขอบสีแบรนด์ + ไอคอน check สีแบรนด์
  - เสร็จแล้ว = วงกลม**ทึบ**สีแบรนด์ `#014BAA` + ไอคอน check สีขาว + ชื่องานขีดฆ่าเป็นสีเทา
